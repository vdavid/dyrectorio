...
export const ContainerConfig = {
  encode(message: ContainerConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.annotations !== undefined) {
      Marker.encode(message.annotations, writer.uint32(8026).fork()).ldelim()
    }
    if (message.labels !== undefined) {
      Marker.encode(message.labels, writer.uint32(8034).fork()).ldelim()
    }
    return writer
  },
...
export const PatchInstanceRequest = {
  encode(message: PatchInstanceRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.annotations !== undefined) {
      Marker.encode(message.annotations, writer.uint32(834).fork()).ldelim()
    }
    if (message.labels !== undefined) {
      Marker.encode(message.labels, writer.uint32(842).fork()).ldelim()
    }
    return writer
  },
