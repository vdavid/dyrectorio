...
export interface Marker {
  deployment?: KeyValueList | undefined
  service?: KeyValueList | undefined
  ingress?: KeyValueList | undefined
}
...
export const ExplicitContainerConfig = {
  encode(message: ExplicitContainerConfig, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.annotations !== undefined) {
      Marker.encode(message.annotations, writer.uint32(8066).fork()).ldelim()
    }
    if (message.labels !== undefined) {
      Marker.encode(message.labels, writer.uint32(8074).fork()).ldelim()
    }
    return writer
  },
...
export const Marker = {
  encode(message: Marker, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.deployment !== undefined) {
      KeyValueList.encode(message.deployment, writer.uint32(8002).fork()).ldelim()
    }
    if (message.service !== undefined) {
      KeyValueList.encode(message.service, writer.uint32(8010).fork()).ldelim()
    }
    if (message.ingress !== undefined) {
      KeyValueList.encode(message.ingress, writer.uint32(8018).fork()).ldelim()
    }
    return writer
  },
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Marker {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1000:
          message.deployment = KeyValueList.decode(reader, reader.uint32())
          break
        case 1001:
          message.service = KeyValueList.decode(reader, reader.uint32())
          break
        case 1002:
          message.ingress = KeyValueList.decode(reader, reader.uint32())
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  fromJSON(object: any): Marker {
    return {
      deployment: isSet(object.deployment) ? KeyValueList.fromJSON(object.deployment) : undefined,
      service: isSet(object.service) ? KeyValueList.fromJSON(object.service) : undefined,
      ingress: isSet(object.ingress) ? KeyValueList.fromJSON(object.ingress) : undefined,
    }
  },
  ...
  toJSON(message: Marker): unknown {
    ...
    message.deployment !== undefined &&
      (obj.deployment = message.deployment ? KeyValueList.toJSON(message.deployment) : undefined)
    message.service !== undefined && (obj.service = message.service ? KeyValueList.toJSON(message.service) : undefined)
    message.ingress !== undefined && (obj.ingress = message.ingress ? KeyValueList.toJSON(message.ingress) : undefined)
    return obj
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Marker>, I>>(object: I): Marker {
    ...
    message.deployment =
      object.deployment !== undefined && object.deployment !== null
        ? KeyValueList.fromPartial(object.deployment)
        : undefined
    message.service =
      object.service !== undefined && object.service !== null ? KeyValueList.fromPartial(object.service) : undefined
    message.ingress =
      object.ingress !== undefined && object.ingress !== null ? KeyValueList.fromPartial(object.ingress) : undefined
    return message
  },
}
