  ...
  fromJSON(object: any): AgentCommand {
    ...
    message.listSecrets =
      object.listSecrets !== undefined && object.listSecrets !== null
        ...
        : undefined
    message.update =
      object.update !== undefined && object.update !== null ? AgentUpdateRequest.fromJSON(object.update) : undefined
    return message
  },
...
const baseAgentUpdateRequest: object = {}

export const AgentUpdateRequest = {
  fromJSON(_: any): AgentUpdateRequest {
    const message = { ...baseAgentUpdateRequest } as AgentUpdateRequest
    return message
  },

  toJSON(_: AgentUpdateRequest): unknown {
    const obj: any = {}
    return obj
  },
}
